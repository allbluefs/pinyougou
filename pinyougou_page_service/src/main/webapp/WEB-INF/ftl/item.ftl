		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${goods.categoryMap.getCategory1Name}</a>
					</li>
					<li>
						<a href="#">${goods.categoryMap.getCategory2Name}</a>
					</li>
					<li>
						<a href="#">${goods.categoryMap.getCategory3Name}</a>
					</li>
					...
					<div class="fr itemInfo-wrap">
						...
						<div class="clearfix choose">
							<div id="specification" class="summary-wrap clearfix">
								<#--[{"attributeValue":["移动4G","移动3G"],"attributeName":"网络"},
								{"attributeValue":["128G","64G"],"attributeName":"机身内存"}]-->
								<#assign specItemList=goods.goodsDesc.specificationItems?eval />
								<#if (specItemList?size>0)>
									<#list specItemList as specItem>
										<dl>
											<dt>
											<div class="fl title">
											...
											<#list specItem.attributeValue as value>
												<dd><a href="javascript:" ng-click="updateSelected('${specItem.attributeName}','${value}')" class="{{checkSelected('${specItem.attributeName}','${value}')?'selected':''}}">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
											</#list>
										</dl>
									</#list>
